...
from pyspark.sql.window import Window
    ##ATUCAD
class transformation_atucad:
    
    def __init__(self,spark):
        self.spark = spark

    def processing_atucad(self,path):
...
class transformation_customerexp:
    def __init__(self,spark):
        self.spark = spark

    def processing_customerexp(self,path):
...
class transformation_portalcliente:
    def __init__(self,spark):
        self.spark = spark

    def processing_portalcliente(self,path):
